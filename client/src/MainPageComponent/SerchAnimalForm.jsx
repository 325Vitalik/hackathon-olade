		...
		<div className={styles.searchFormWrapper}>
			<Form className={styles.searchForm}>
				...
				<Form.Field>
					...
					<input
						placeholder="Мурзик"
						value={componentState.animalName}
						onChange={(e) => {
				...
				<Form.Field>
					<SelectBreed
						onChange={createChangeAction(filterActions.setAnimalBreed)}
						animalType={componentState.animalType}
					/>
				</Form.Field>
				<Form.Field>
				...
				<Form.Field>
					<SelectAddress
						...
						onChangeCoordinates={(coordinates) =>
							componentDispatch({
								type: filterActions.setAnimalLossLocationCoordinates,
								payload: coordinates,
							})
						}
					...
					onClick={() => {
						...
						dispatch(
							loadPetsWithQuery(
								clearUndefined({
									...queryData,
									type: window.location.pathname === "/search" ? "search" : "found",
								})
							)
						);
					}}
